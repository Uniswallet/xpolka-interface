    ...
    if (step === 'disclaimer') {
      return (
        <div>
          <p>Audits: None.</p>
          <p>
            While the initial creators of the xPolka protocol have made
      ...
      return (
        <div>
          <p>Attention xPolka Uniswap LPs</p>
          <p>
            The only Uniswap pool that is compatible with XPK is XPK/ETH
            (Curve yPool tokens)
          </p>
